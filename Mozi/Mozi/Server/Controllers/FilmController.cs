...
namespace Mozi.Server.Controllers
{
    ...
    public class FilmController : ControllerBase
    {
        ...
        public static List<Film> Filmek = new List<Film> { 
            new Film{ Id=1, Ertekeles=6.0, Gyarto="ASD", Terem=Termek[0], TeremId=1, Nev="elso nevu", szineszek=Szineszek},
            new Film{ Id=2, Ertekeles=8.0, Gyarto="ASDASD", Terem=Termek[1], TeremId=2, Nev="masodik nevu", szineszek=Szineszek.GetRange(0,2)}     
        };
